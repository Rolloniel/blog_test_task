    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', ckeditor_uploader.fields.RichTextUploadingField(blank=True, verbose_name='Content')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customcomment_comments', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
